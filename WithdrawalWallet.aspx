<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.Master" AutoEventWireup="true" CodeBehind="WithdrawalWallet.aspx.cs" Inherits="ProfitTrader.Admin.WithdrawalWallet" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Withdrawal Wallet Add / Remove</h4>
            </div>
            <div class="card-body">
                <div class="row">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Withdrawal Wallet Details</h4>
            </div>
            <div class="card-body">
