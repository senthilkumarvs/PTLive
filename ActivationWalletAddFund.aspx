<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.Master" AutoEventWireup="true" CodeBehind="ActivationWalletAddFund.aspx.cs" Inherits="ProfitTrader.Admin.ActivationWalletAddFund" %>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Activation Wallet Add / Remove</h4>
            </div>
            <div class="card-body">
                <div class="row">
