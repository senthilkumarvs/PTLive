<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.Master" AutoEventWireup="true" CodeBehind="CustomerLogin.aspx.cs" Inherits="ProfitTrader.Admin.CustomerLogin" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="ava_s_card">
                <div class="ava_s_card_head">Login Details</div>
                    ...
                    <asp:GridView ID="GridView1" runat="server" ShowFooter="false" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="User Code">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_user_code" runat="server" Text='<%#Eval("usercode") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="User Name">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_user_name" runat="server" Text='<%#Eval("username") %>'></asp:Label>
                                    <asp:Label ID="lbl_mobno" runat="server" Text='<%#Eval("contactno") %>' Visible="false"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField> 
                            <asp:TemplateField HeaderText="Contact Number">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_mobno1" runat="server" Text='<%#Eval("contactno") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Login Details">
                                <ItemTemplate>
                                    User Name&nbsp;:&nbsp;&nbsp
                                        <asp:Label ID="lbl_logusername" runat="server" Text='<%#Eval("usercode") %>'></asp:Label><br />
