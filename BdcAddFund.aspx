<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.Master" AutoEventWireup="true" CodeBehind="BdcAddFund.aspx.cs" Inherits="ProfitTrader.Admin.BdcAddFund" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">BDC Wallet Add / Remove</h4>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="wcf-set">
                            <div class="wcf-s-lbl">BDC Code</div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">BDC Wallet Details</h4>
            </div>
            <div class="card-body">
                        ...
                        <asp:GridView ID="GridView1" runat="server" class="table table-striped custom-table table-hover" GridLines="None"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="UserCode">
                                    <ItemTemplate>
                                        <asp:Label ID="LUserCode" runat="server" Text='<%#Bind("BdcCode") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
