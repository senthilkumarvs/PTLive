<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.Master" AutoEventWireup="true" CodeBehind="WeeklyPayoutView.aspx.cs" Inherits="ProfitTrader.Admin.WeeklyPayoutView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="ava_s_card">
                <div class="ava_s_card_head">Manual Payout Generate</div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="ava_s_card">
                <div class="ava_s_card_head">Payout Report</div>
                <div class="ava_s_card_body">
                    <div class="row">
                        ...
                        <asp:GridView ID="GridView1" runat="server" ShowFooter="true" OnRowDataBound="GridView1_RowDataBound" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Amount" Visible="true">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_netAmount" runat="server" Text='<%#Eval("netamount") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
