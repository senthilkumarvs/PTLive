<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.Master" AutoEventWireup="true" CodeBehind="ReturnsWalletAddFund.aspx.cs" Inherits="ProfitTrader.Admin.ReturnsWalletAddFund" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Returns Wallet Add / Remove</h4>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="wcf-set">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TxtRemarks" ValidationGroup="vg" class="ava_s_frm_vld" ErrorMessage="*"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="wcf-set">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Returns Wallet Details</h4>
            </div>
            <div class="card-body">
                        ...
                        <asp:GridView ID="GridView1" runat="server" class="table table-striped custom-table table-hover" GridLines="None"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Remarks">
                                    <ItemTemplate>
                                        <asp:Label ID="LTransactionId" runat="server" Text='<%#Bind("TransactionId") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
