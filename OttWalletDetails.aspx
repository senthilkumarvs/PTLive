<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.Master" AutoEventWireup="true" CodeBehind="OttWalletDetails.aspx.cs" Inherits="ProfitTrader.Admin.OttWalletDetails" %>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">OTT Wallet Details</h4>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
