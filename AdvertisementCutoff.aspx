<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.Master" AutoEventWireup="true" CodeBehind="AdvertisementCutoff.aspx.cs" Inherits="ProfitTrader.Admin.AdvertisementCutoff" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="ava_s_card">
                <div class="ava_s_card_head">Advertisement Cutoff Details</div>
                <div class="ava_s_card_body">

                    <div id="div1" runat="server">
                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" PageSize="50" OnPageIndexChanging="GridView2_PageIndexChanging" ShowFooter="true"
