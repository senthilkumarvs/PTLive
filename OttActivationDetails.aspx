<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.Master" AutoEventWireup="true" CodeBehind="OttActivationDetails.aspx.cs" Inherits="ProfitTrader.Admin.OttActivationDetails" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="ava_s_card">
                <div class="ava_s_card_head">Ott Activation Details</div>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" OnPageIndexChanging="GridView1_PageIndexChanging" AllowPaging="true" PageSize="100"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Mobile">
                                    <ItemTemplate>
                                        <asp:Label ID="luser_name" runat="server" Text='<%# Eval("contactno") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                  <asp:TemplateField HeaderText="Plan">
                                    <ItemTemplate>
                                        <asp:Label ID="luser_name" runat="server" Text='<%# Eval("PlanDetails") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Activation">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_date" runat="server" Text='<%# Eval("StartingFrom","{0:dd/MM/yyyy}") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField> 
                                <asp:TemplateField HeaderText="Remaining Days">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_date" runat="server" Text='<%# Eval("RemainingDays") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField> 
                                <asp:TemplateField HeaderText="Amount" ItemStyle-ForeColor="Blue">
                                    <ItemTemplate>
                                        <asp:Label ID="LBalance" runat="server" Text='<%# Eval("Amount","{0:n}")%>'></asp:Label>
                                    </ItemTemplate>
