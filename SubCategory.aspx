<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.Master" AutoEventWireup="true" CodeBehind="SubCategory.aspx.cs" Inherits="ProfitTrader.Admin.SubCategory" %>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                        <div class="wcf-set">
                            <div class="wcf-s-lbl">Sub Category Name</div>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TxtName" ValidationGroup="vg" class="ava_s_frm_vld" ErrorMessage="*"></asp:RequiredFieldValidator>
                        ...
                        <asp:GridView ID="GridView1" runat="server" class="table table-bordered table-hover table-responsive-lg ava_mrgn_btm_0 ava_s_tb_td" GridLines="None"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Category Name">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="LCategoryId" Visible="false" runat="server" Text='<%#Bind("CategoryId") %>'></asp:Label>
                                        <asp:Label ID="LSubscription" runat="server" Text='<%#Bind("SubCategoryName") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
