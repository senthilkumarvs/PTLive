<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.Master" AutoEventWireup="true" CodeBehind="FundAddRemove.aspx.cs" Inherits="ProfitTrader.Admin.FundAddRemove" %>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Customer Wallet Add / Remove</h4>
            </div>
            <div class="card-body">
                <div class="row">
